    ...
    return (
        <div className="sm:flex sm:justify-between mb-6">
            ...
            {router.pathname === "/pedidos" &&
                <p className="mr-2 mb-5 lg:mb-0 bg-indigo-800 text-white p-3">Hola {nombre} {apellido}, estos son tus pedidos</p>
            }

            {router.pathname === "/productos" &&
                <p className="mr-2 mb-5 lg:mb-0 bg-indigo-800 text-white p-3">Hola {nombre} {apellido}, estos son tus productos</p>
            }
