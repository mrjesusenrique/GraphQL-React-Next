...
const Producto = ({ producto }) => {
    ...
    return (
        <tr>
            ...
            <td className="border px-4 py-2">
                <button onClick={() => editarProducto()} type="button" className="flex justify-center items-center hover:bg-green-700 bg-green-600 text-white py-2 px-4 w-full rounded uppercase text-xs text-light">
